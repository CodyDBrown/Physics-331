...
\makeatother
    ...
    \section*{HW 0: Example Solutions}\label{hw-0-example-solutions}

You do not have to do this. These are some extra problems you could do
if you want. But this is mainly just so that you have an example of what
I'm looking for in your solutions

    \subsubsection*{Problem 1: Pitching a
Strike}\label{problem-1-pitching-a-strike}
